...
int input_phone_num(USER *head,char *phone_num,char *code,USEINFOR *orderhead,int *x,int *y)
{
	...
	fdhz(241,291,2,2,"电",63776);
	fdhz(271,291,2,2,"话",63776);//标亮
...
int input_code(USER *head,char *phone_num,char *code,USEINFOR *orderhead,int *x,int *y)
{
	...
	fdhz(241,441,2,2,"密",63776);//标亮
	fdhz(271,441,2,2,"码",63776);
...
int register_in_phone_num(char *phone_num, int *mx, int *my)
{
	...
	fdhz(291,241,2,2,"电",63776);
	fdhz(321,241,2,2,"话",63776);//标亮
...
int register_in_code(char *code, int *mx, int *my) 
{
	...
	fdhz(291,341,2,2,"密",63776);//标亮
	fdhz(321,341,2,2,"码",63776);
	fdhz(311,441,2,2,"密",64384);
	fdhz(341,441,2,2,"码",64384);
	fdhz(251,441,2,2,"确",64384);
	fdhz(281,441,2,2,"认",64384);
...
int register_in_code_2(char *code2, int *mx, int *my)
{
	...
	fdhz(291,341,2,2,"密",64384);//标亮
	fdhz(321,341,2,2,"码",64384);
	fdhz(311,441,2,2,"密",63776);
	fdhz(341,441,2,2,"码",63776);
	fdhz(251,441,2,2,"确",63776);
	fdhz(281,441,2,2,"认",63776);
