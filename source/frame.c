...
void load_page(void)
{
	...
	fdhz(240,290,2,2,"账",0);
	fdhz(270,290,2,2,"号",0);
	fdhz(241,291,2,2,"账",64384);
	fdhz(271,291,2,2,"号",64384);
    ...
    fdhz(240,615,3,3,"登",0);
	fdhz(320,615,3,3,"录",0);
	fdhz(640,615,3,3,"注",0);
	fdhz(720,615,3,3,"册",0);
...
void register_page(void)
{
	...
	bar_round(500,700,100,50,5,1,65535);//注册
	fdhz(290,240,2,2,"账",0);
	fdhz(320,240,2,2,"号",0);
	fdhz(291,241,2,2,"账",64384);
	fdhz(321,241,2,2,"号",64384);
	...
	fdhz(463,685,2,2,"注",0);
	fdhz(507,685,2,2,"册",0);
